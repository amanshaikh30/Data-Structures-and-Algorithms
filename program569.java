...
class MarvellousDBMS
{
    ...
    public void AggregateSum()
    {
        ...
        System.out.println("Sum of Salaries in the Employee Table : "+iSum);
    }
...
class program569
{
    public static void main(String Arg[])
    {
        ...
        while(true)
        {
            ...
            System.out.println("2 : Display all records in the table");
            System.out.println("3 : Display specific records in the table with ID");
            System.out.println("4 : Display specific records in the table with Name");
            ...
            System.out.println("7 : Summation of Salary in the records");
            System.out.println("8 : Average of Salary in the records");
            System.out.println("9 : Maximum of Salary in the records");
            System.out.println("10 : Minimum of Salary in the records");
            System.out.println("11 : Update the existing records");
            System.out.println("12 : Delete the table");
            System.out.println("13 : Terminate the DBMS");
